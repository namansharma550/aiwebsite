...
const Home = () => {
  ...
  const getAllapi = () => {
    const apiUrl1 = `${apiUrl}/category/getall`;
    axios
      .get(apiUrl1)
      .then((response) => {
  ...
  const getAllproduct = () => {
    const apiUrl1 = `${apiUrl}/tool/getall`;
    axios
      .get(apiUrl1)
      .then((response) => {
        console.log(response.data);
  ...
  return (
    <>
      ...
      <Categeory2 elevation={3} style={{ height: "10vh" }}>
        <FeaturedToolsHeading variant="h4">
          Popular Categeories
        </FeaturedToolsHeading>
        <Categeory2>
          {/* <StyledTypography variant="h5"></StyledTypography> */}
